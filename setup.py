...
pip wheel --no-index --no-deps --wheel-dir dist dist/jsonmodel-3.0.tar.gz

Upload (or Register) Distributions to PyPi:
twine upload dist/jsonmodel-3.0*
...
pip install dist/jsonmodel-3.0-py3-none-any.whl # when possessing wheel file
